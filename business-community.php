<?php
/**
 * Template Name: be-part-of-a-business-community
 *
 * @package WordPress
 */
...
$services = list_services($wpdb, 'business_community');
?>

<div id="discover_container">
	<img class="service_title" src="<?php echo $image_path; ?>/images/discover/business_community.png"/>
