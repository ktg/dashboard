            ...
            <!--      	<li> <?php echo $service->title;?> - <a href="" onclick="addService('<?php echo $service->id;?>');"> Add to Dashboard </a></li> -->
				...
				<li>
					<form name="loginform" id="loginform" action="<?php echo esc_url( site_url( 'services') ); ?>" method="post"> 
						...
						<a target="_blank" href="<?php echo $service->tutorial_url; ?>">Tutorial</a> <input type="hidden" name="service_id" id="service_id"
							value='<?php echo $service->id;?>' /> <input type="hidden" name="service_title" id="service_title" value='<?php echo $service->title;?>' /> <input
							type="submit" name="wp-submit" id="wp-submit" value="Add" />
