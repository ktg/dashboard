...
/**
 * Template Name: market-your-business
 *
 * @package WordPress
 */
...
$query = $wpdb->prepare ( "SELECT * FROM " . $wpdb->prefix . "services WHERE category = 'market'" );
// $results = $wpdb->query($query);
...
$theme = get_template ();
$image_path = site_url ( 'wp-content/themes/' . $theme . '/images/discover/market/' );
...
<div id="default_container3">
	...
	<div id="service_area">
			...
			<div id="service_box">
				...
				</a> <input type="hidden" name="service_id" id="service_id" value='<?php echo $service->id;?>' /> <input type="hidden" name="service_title"
					id="service_title" value='<?php echo $service->title;?>' /> <input type="submit" name="wp-submit" id="wp-submit" class="btn_service_add"
