...
<div class="steps">
	...
	<div class="step">
		<a href="<?php bloginfo('url'); ?>/discover/business-community"><img width='365px' height='53px' src="<?php echo $title_path; ?>4.png"></a>
	...
	<div class="step">
		<a href="<?php bloginfo('url'); ?>/discover/communicate-with-customers"><img width='365px' height='53px' src="<?php echo $title_path; ?>2.png"></a>
	...
	<div class="step">
		<a href="<?php bloginfo('url'); ?>/discover/know-who-your-customers-are"><img width='365px' height='53px' src="<?php echo $title_path; ?>3.png"></a>
	...
	<div class="step">
		<a href="<?php bloginfo('url'); ?>/discover/sell-online"><img width='365px' height='53px' src="<?php echo $title_path; ?>5.png"></a>
	...
	<div class="step">
		<a href="<?php bloginfo('url'); ?>/discover/send-packages"><img width='365px' height='53px' src="<?php echo $title_path; ?>6.png"></a>
