...
$query = $wpdb->prepare("Select * From ".$wpdb->prefix."services WHERE category = 'communicating'");
//$results = $wpdb->query($query);
...
$theme=get_template();
$image_path=site_url('wp-content/themes/'.$theme.'/images/discover/communicating/');
