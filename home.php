...
<div id="container">
	...
	<div id="sign_up_container">
		<div id="signup_text">
			...
			<p>'Dashboard' is a prototype developed by the University of Nottingham for the RCUK funded project 'Scaling the Rural Divide'.</p>
		...
		<div id="signup" class="signup_form">
			<form name="register" method="post">
				<label for="userLogin"><?php _e('Username*')?>
                                <span class="small">Create a username</span> </label> <input type="text" name="username" id="username" value=""
					size="20" /> <label for="userEmail"><?php _e('Email*')?>
                                <span class="small">Add a valid email address</span> </label> <input type="text" name="email_reg" id="email_reg"
					value="" size="20" /> <label for="userPassword"><?php _e('Password*')?>
                                <span class="small">Choose a password</span> </label> <input type="password" name="pwd1_reg" id="pwd1_reg" value="" />

				<label for="userPasswordReenter"><?php _e('Confirm Password*')?>
                                <span class="small">Re-enter password</span> </label> <input type="password" name="pwd2_reg" id="pwd2_reg" value="" />
