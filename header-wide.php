			...
			?>
		 	...
		 	<form method="post" action="<?php echo esc_url( site_url( 'wp-login.php', 'login_post' ) );?>" id="loginform" name="loginform">
				<p class="login-username">
					<label for="user_login">Username:</label> <input type="text" size="15" value="" class="input p0 mr5" id="user_login" name="log"> <label
						for="user_pass">Password:</label> <input type="password" size="15" value="" class="input p0 mr5" id="user_pass" name="pwd"> <input type="submit"
						value="  Log In  " class="button-primary p0" id="submitLogin" name="wp-submit"> <input type="hidden"
						value="<?php echo esc_url( $args['redirect'] );?>" name="redirect_to"> <b>|</b>
